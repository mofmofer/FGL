...
# プロット用のデータフレームを読み込む
FGL_plot = pd.read_csv("/Users/kawakami/Desktop/fight/STEP4/STEP4_5/data/FGL_unid_プロット用_閾値{}.csv".format(threshold), header=0).drop(["Unnamed: 0"], axis=1)
...
plt.savefig("/Users/kawakami/Desktop/fight/STEP4/STEP4_6/data/hist_agn_and_psr.png", format='png', dpi=100)
...
plt.xlabel('天体数',fontsize=18)
plt.ylabel('銀緯',fontsize=18)
plt.savefig("/Users/kawakami/Desktop/fight/STEP4/STEP4_6/data/hist_other.png", format='png', dpi=100)
