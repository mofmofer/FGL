...
FGL = fgl("/Users/kawakami/Desktop/fight/STEP5/STEP5_2/4FGL_AGN_PSR_std.csv").loc[:,
      ['Conf_68_SemiMajor',
...
print(range(len(FGL.columns)))
plt.barh(label, feature_importance, tick_label=label, align="center")
plt.savefig('/Users/kawakami/Desktop/fight/STEP5/STEP5_4/result/figure.png', format='png', dpi=100)
