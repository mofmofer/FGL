...
def train_data_info(FGL, i):
    ...
    X_test = X_test_list[i].values
    # csvにデータの大きさの情報を保存
    path = "/Users/kawakami/Desktop/fight/STEP5/STEP5_4/result/DataSize{}.csv".format(i)
...
def learn(FGL, i):
    ...
    # csvに予測精度結果を保存
    path = "/Users/kawakami/Desktop/fight/STEP5/STEP5_4/result/model_acc_dataset{}.csv".format(i)
