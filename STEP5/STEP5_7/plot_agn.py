...
FGL_plot_AGN = pd.read_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_1/4FGL_AGN.csv", header=0).drop(["Unnamed: 0"], axis=1)
...
plt.savefig("/Users/kawakami/Desktop/fight/STEP5/STEP5_7/AGNness_AGNlike.png".format(threshold), format='png', dpi=400)
