...
FGL_AGNness = pd.read_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_1/4FGL_AGN.csv", header=0).drop(["Unnamed: 0"], axis=1)['GLON']
FGL_AGNlike = pd.read_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_LR/FGL_unid_AGN_like_閾値0.9.csv", header=0).drop(["Unnamed: 0"], axis=1)['GLON']
...
plt.savefig("/Users/kawakami/Desktop/fight/STEP5/STEP5_7/hist_agnness.png", format='png', dpi=100)
