...
ppf.ProfileReport(FGL_unid).to_file(outputfile="/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_grad/unid.html")
...
grb.fit(X, y)
# 予測結果の保存
np.savetxt('/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_grad/unid_prob_{}.csv'.format(threshold), grb.predict_proba(X_unid), delimiter=',')
...
FGL_plot.to_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_grad/FGL_unid_プロット用_閾値{}.csv".format(threshold))
FGL_plot[FGL_plot['label'] == 'AGNlike'].to_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_grad/FGL_unid_AGN_like_閾値{}.csv".format(threshold))
FGL_plot[FGL_plot['label'] == 'PSRlike'].to_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_grad/FGL_unid_PSR_like_閾値{}.csv".format(threshold))
FGL_plot[FGL_plot['label'] == 'Otherlike'].to_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_grad/FGL_unid_Other_like_閾値{}.csv".format(threshold))
