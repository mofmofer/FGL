...
# csvにデータを保存
FGL.to_csv('/Users/kawakami/Desktop/fight/STEP5/STEP5_1/4FGL.csv')

# AGNのラベルづけ
print('AGNのラベルづけを行っています...')
agn_class = ['BLL', 'bll', 'FSRQ', 'fsrq', 'RDG', 'rdg', 'NLSY1', 'nlsy1', 'ssrq', 'sey']
FGL['AGNness'] = ''
sleep(1)
for i in tqdm(range(len(FGL['CLASS1']))):
...
print()
# csvに保存
FGL_AGN_PSR.to_csv('/Users/kawakami/Desktop/fight/STEP5/STEP5_1/4FGL_AGN_PSR.csv')
FGL_unid.to_csv('/Users/kawakami/Desktop/fight/STEP5/STEP5_1/4FGL_Unid.csv')
