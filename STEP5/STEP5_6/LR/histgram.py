...
plt.savefig("/Users/kawakami/Desktop/fight/STEP5/STEP5_6/LR/data/hist_agn_and_psr.png", format='png', dpi=100)
...
plt.xlabel('天体数',fontsize=18)
plt.ylabel('銀緯',fontsize=18)
plt.savefig("/Users/kawakami/Desktop/fight/STEP5/STEP5_6/LR/data/hist_other.png", format='png', dpi=100)
