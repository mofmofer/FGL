...
# プロット用のデータフレームを読み込む
FGL_plot = pd.read_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_5/data_SVM/FGL_unid_プロット用_閾値0.9.csv", header=0).drop(["Unnamed: 0"], axis=1)
...
plt.savefig("/Users/kawakami/Desktop/fight/STEP5/STEP5_6/SVM/data/Predict.png", format='png', dpi=100)

# ラベルのカウントアップ
FGL_plot['label'].value_counts().to_csv("/Users/kawakami/Desktop/fight/STEP5/STEP5_6/SVM/data/予測クラス数.csv")
