...
plt.colorbar(plot1, ax=ax).ax.tick_params(labelsize=20)

ax.grid(True)
ax.legend([plot1], ["AGNlike", "PSRlike"], loc=1, prop={'size': 20}, title_fontsize=20)

plt.savefig("/Users/kawakami/Desktop/fight/STEP3/STEP3_6/data/Predict_agn_{}.png".format(threshold), format='png', dpi=100)
