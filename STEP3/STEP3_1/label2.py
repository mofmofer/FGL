...
FGL_AGN_PSR[lambda df: (df.PSRness == "PSR")].loc[:, ["GLON", "GLAT", "PSRness"]].to_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_1/4FGL_PSR.csv")
FGL_AGN_PSR[lambda df: (df.PSRness == "Non-PSR")].loc[:, ["GLON", "GLAT", "PSRness"]].to_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_1/4FGL_AGN.csv")
# 天体数の確認
