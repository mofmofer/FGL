...
FGL_PSRness = pd.read_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_1/4FGL_PSR.csv", header=0).drop(["Unnamed: 0"], axis=1)['GLON']
FGL_PSRlike = pd.read_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_5/data/FGL_unid_PSR_like_閾値0.9.csv", header=0).drop(["Unnamed: 0"], axis=1)['GLON']
...
plt.savefig("/Users/kawakami/Desktop/fight/STEP3/STEP3_7/hist_psrness.png", format='png', dpi=400)
