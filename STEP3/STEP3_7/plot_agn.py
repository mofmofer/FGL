...
# プロット用のデータフレームを読み込む
FGL_plot = pd.read_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_5/data/FGL_unid_プロット用_閾値{}.csv".format(threshold), header=0).drop(["Unnamed: 0"], axis=1)
FGL_plot1 = FGL_plot[FGL_plot['label'] == 'PSRlike']
FGL_plot2 = FGL_plot[FGL_plot['label'] == 'AGNlike']

FGL_plot_AGN = pd.read_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_1/4FGL_AGN.csv", header=0).drop(["Unnamed: 0"], axis=1)
FGL_plot_PSR = pd.read_csv("/Users/kawakami/Desktop/fight/STEP3/STEP3_1/4FGL_PSR.csv", header=0).drop(["Unnamed: 0"], axis=1)
...
plt.savefig("/Users/kawakami/Desktop/fight/STEP3/STEP3_7/AGNness_AGNlike.png".format(threshold), format='png', dpi=400)
