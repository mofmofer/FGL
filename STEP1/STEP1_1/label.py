...
# csvにデータを保存
FGL.to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL.csv")
...
FGL = FGL.drop(
    ["Conf_95_SemiMajor", "Conf_95_SemiMinor", "Flux100_300", "Conf_68_PosAng", 'Unc_PLEC_Exp_Index', 'ASSOC2',
...
print('AGNでPowerLawでfittingされるもの', FGL[lambda df: (df.SpectrumType == "PowerLaw") & (df.AGNness == "AGN")].shape)
print('AGNでLogParabolaでfittingされるもの', FGL[lambda df: (df.SpectrumType == "LogParabola") & (df.AGNness == "AGN")].shape)
print('AGNでPLSuperExpCutoffでfittingされるもの', FGL[lambda df: (df.SpectrumType == "PLSuperExpCutoff") & (df.AGNness == "AGN")].shape)
print('PSRでPowerLawでfittingされるもの', FGL[lambda df: (df.SpectrumType == "PowerLaw") & (df.PSRness == "PSR")].shape)
print('PSRでLogParabolaでfittingされるもの', FGL[lambda df: (df.SpectrumType == "LogParabola") & (df.PSRness == "PSR")].shape)
print('PSRでPLSuperExpCutoffでfittingされるもの', FGL[lambda df: (df.SpectrumType == "PLSuperExpCutoff") & (df.PSRness == "PSR")].shape)
# 欠損値の処理
print('欠損値の処理を行います')
...
print()
# csvに保存
FGL_AGN_PSR.to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL_AGN_PSR.csv")
FGL_unid.to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL_Unid.csv")

FGL_AGN_PSR[lambda df: (df.PSRness == "PSR")].loc[:, ["GLON", "GLAT", "PSRness"]].to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL_PSR.csv")
FGL_AGN_PSR[lambda df: (df.PSRness == "Non-PSR")].loc[:, ["GLON", "GLAT", "PSRness"]].to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL_AGN.csv")
