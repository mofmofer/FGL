...
plt.savefig("/Users/kawakami/Desktop/fight/STEP1/STEP1_6/data/hist_agn_and_psr.png", format='png', dpi=100)
...
plt.xlabel('GLAT',fontsize=40)
plt.ylabel('Count',fontsize=40)
plt.savefig("/Users/kawakami/Desktop/fight/STEP1/STEP1_6/data/hist_other.png", format='png', dpi=100)
