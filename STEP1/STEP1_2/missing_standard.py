...
FGL_AGN_PSR = pd.read_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL_AGN_PSR.csv", header=0).drop(["Unnamed: 0"],
                                                                            axis=1)
FGL_AGN_PSR['Extended_Source_Name'] = FGL_AGN_PSR['Extended_Source_Name'].astype(object)
FGL_Unid = pd.read_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_1/4FGL_Unid.csv", header=0).drop(["Unnamed: 0"], axis=1)
...
standard.to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_2/4FGL_AGN_PSR_std.csv")
"""
# データを元の形に戻す
...
standard.to_csv("/Users/kawakami/Desktop/fight/STEP1/STEP1_2/4FGL_Unid_std.csv")
